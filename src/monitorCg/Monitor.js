...
import AddCgComment from './addCgComment';
...
const Monitor = props => {
  ...
  const [modalCgCommentList, setModalCgCommentList] = React.useState(false);
  ...
  const getbooking = async () => {
    ...
    fetch(url + 'monitor.php', requestOptions)
      ...
      .then(response => {
        ...
        // let taxiPoints = [
        //   {
        //     img: 'https://cdn-icons-png.flaticon.com/512/171/171241.png',
        //     name: 'คนขับรถ',
        //     position: {
        //       latitude: 13.726912,
        //       longitude: 100.476083,
        ...
        //   },
        //   {
        //     img: 'https://cdn-icons-png.flaticon.com/512/3105/3105867.png',
        //     name: 'ผู้ดูแล',
        //     position: {
        //       latitude: 13.728912,
        //       longitude: 100.47083,
    ...
    return (
      <View
        ...
        <View
            ...
            <View
              ...
              <View
                ...
                <View style={{marginLeft: 10}}>
                  ...
                  <Text style={{color: 'gray', fontSize: 12}}>
                    {conv_formatTel(trip.gmm_user_tel)}
                  </Text>
                </View>
              </View>
          ...
          <View style={{marginVertical: 5, width: '100%', flex: 1}}>
            <View
              style={{
                display: 'flex',
                flexDirection: 'row',
              ...
              <TouchableOpacity
                ...
                style={{flex: 1.5, marginHorizontal: 2}}>
                <View
                  style={{
                    borderWidth: 0.2,
                    borderColor: 'gray',
                  ...
                  <Icon name="comment-edit" color="gray" size={24} />
                  <Text style={{width: '100%', color: 'gray', marginLeft: 5}}>
                    เพิ่มบันทึกผู้ดูแล
                  </Text>
                </View>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                ...
                <View
                  ...
                  <Icon name="clipboard-list-outline" color="gray" size={24} />
                  <Text style={{width: '100%', color: 'gray', marginLeft: 5}}>
                    ดูการบันทึก
                  </Text>
                </View>
